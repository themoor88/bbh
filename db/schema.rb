...
ActiveRecord::Schema.define(version: 20160523203813) do
  ...
  add_index "tech_providers", ["email"], name: "index_tech_providers_on_email", unique: true, using: :btree
  add_index "tech_providers", ["reset_password_token"], name: "index_tech_providers_on_reset_password_token", unique: true, using: :btree

  create_table "tech_seekers", force: :cascade do |t|
    t.string   "email",                  limit: 255, default: "",    null: false
    t.boolean  "active",                             default: false
    t.string   "encrypted_password",     limit: 255, default: "",    null: false
    t.string   "reset_password_token",   limit: 255
  ...
  add_index "tech_seekers", ["email"], name: "index_tech_seekers_on_email", unique: true, using: :btree
  add_index "tech_seekers", ["reset_password_token"], name: "index_tech_seekers_on_reset_password_token", unique: true, using: :btree
